        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/enders9245/recursos2.git'
                }
            }
        }
        stage('Build') {
